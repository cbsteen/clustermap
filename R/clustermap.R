...
#' clustermap
#' @description clustermap is a package for hierarchical clustering and heatmap visualisation of numerical
#' data matrices.
#' @docType package
#' @name clustermap
...
#' @param text Integer. Adds text.
#' @param cbar Integer. Adds a color bar.
#' @param ckey Boolean. Default is TRUE.
